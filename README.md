...
Директория app - файлы Web-приложения <br>
Директория data - исходные данные в виде двух таблиц <br>
Директория models - Разработанные ML модели <br>
Composites.ipynb - блокнот с анализом данных и разработкой моделей <br>
